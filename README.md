...
This one is a Company Website Landing Page which is created using HTML & CSS. This website is currently mobile responsive. In this project target is without edit in given HTML make responsive Landing page using _CSS and @Media Queries_.
...
## 🔗PROJECT-9 : _Screenshot_

![Project 9](thumbnail.png)

## 🔗__This is Ninth Project of Html & CSS with mobile responsive_

A HTML, CSS Project. Made with ♥ by Satyam Jaysawal. There will be a website landing page. In this project we gonna learn how we can create a website using  HTML, CSS. The main purpose of the project is to get more used to with HTML, CSS. Later on, in this project, we gonna learn how we can deploy this site using Netlify. Also, we gonna learn the process from the zero to end and make the website ready for live production.
...
It took me 6 hour to finish this project and it was fun working on it.
...
[![image](https://user-images.githubusercontent.com/108862706/184493986-7bdd92e4-e060-4736-9365-f5e25448090c.png)](https://github.com/satyamjaysawal/HTML-CSS-PROJECT-9)
🔗[Source code](https://github.com/satyamjaysawal)(https://github.com/satyamjaysawal/HTML-CSS-PROJECT-9)

## 🚀 Deployed Link : _Netlify_

[![image](https://user-images.githubusercontent.com/108862706/184974666-250f6d16-200e-44c5-96cd-6e90a53b9f9c.png)](https://html-css-p9.netlify.app/)
(https://html-css-p9.netlify.app/)
